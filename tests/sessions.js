...
class Session {
    constructor(keypair, idl, programId, env) {
        ...
        this.seed = "degenrand-requestor-seed";
        this.vaultSeed = "degenrand-vault-seed";
...
class UserSession extends Session {
    ...
    async setAccounts() {
        ...
        [this.vaultAccount, this.vaultBump] = await anchor.web3.PublicKey.findProgramAddress(
            [Buffer.from(this.vaultSeed), this.keypair.publicKey.toBuffer(), this.programId.toBuffer()],
            this.programId
        );
    }
